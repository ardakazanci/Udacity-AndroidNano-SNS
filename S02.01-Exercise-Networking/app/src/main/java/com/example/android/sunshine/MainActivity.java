...
public class MainActivity extends AppCompatActivity {
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        // JSON Parse ve HTTP isteği işlemini uygular.
        @Override
        protected String[] doInBackground(String... params) {
            // Eğer PostaKodu yoksa ilgili bir bilgi bulunamadığı için null dönecek.
            if (params.length == 0) {
                return null;
            ...
            URL weatherRequestUrl = NetworkUtils.buildUrl(location); // Mantıklı istek URL ' i oluşturuldu
            try {
                // İstek sonucu dönen json veri.
